...
def MSE(test_data):
    ...
    actual=test_data[4]
    means_men.append(sum_a_x/sum_a+ 0.1*test_data[4])
...
#
# ga = GSimpleGA.GSimpleGA(genome,seed=None,interactiveMode=True)
#
# #ga.getMinimax()
...
# means_men = [i for i in range(10)] #(20, 35, 30, 35, 27, 45, 54, 45, 34, 45)
# #std_men = [2, 3, 4, 1, 2, 1, 4, 5, 4, 2] #(2, 3, 4, 1, 2, 1, 4, 5, 4, 2)
#
# means_women = [i for i in range(10,20,1)] #(25, 32, 34, 20, 25, 56, 44, 23, 12, 22)
# #std_women = [3, 5, 2, 3, 3, 2, 3, 4, 4, 2] #(3, 5, 2, 3, 3, 2, 3, 4, 4, 2)
#print len(means_women)
#print means_women[1]
#print means_men[1]
#print len(means_men)
